...
// Deliberate lineage-slice helper pin; unchanged Cell. e7544297 helper was
...
console.log('Mock I/O only; deliberately pinned lineage-slice helper/unchanged Cell; no module evaluation/native/build/signing');
