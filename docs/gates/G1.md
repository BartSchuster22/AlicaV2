...
## Subsequent owner progression

The owner has now authorized dependent G2. See `docs/decisions/G1-ACCEPTANCE.md`; G1 is accepted for this progression. Historical execution evidence remains unchanged.
