...
| --- | --------------------------------------------- | ----------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| E01 | Formal G6 acceptance                          | PENDING; exact candidate passed clean checks including 160 IPC/native tests, but CI/owner exit remains open | Owner confirms exact-candidate CI and acceptance, or explicitly records a scoped exception; no inferred waiver                                                                                    |
...
| E09 | Release evidence/CI process                   | Existing G2 manual control retained; API verification postponed                                             | No new token access/check in this preparation; G7 acceptance needs actual exact-candidate evidence and owner decision                                                                             |
