...
| E03 | Trusted bootstrap and signing custody         | PARTIAL: owner-approved online custody on ElioHermes1, keys created and encrypted off-server copy verified; initial trust ceremony pending; see [custody](CUSTODY.md) | Owner holds passphrase; no unattended signer; bootstrap verifier delivery, root pinning and signed policy/revocation must still be verified; secrets never in chat/repo                           |
